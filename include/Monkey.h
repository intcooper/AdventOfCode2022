...
namespace AdventOfCode
{
    ...
    public:
        ...
        Monkey(std::vector<uint64_t> items, std::function<uint64_t(uint64_t, uint64_t)> operation, uint64_t testDivisor, std::function<void(uint64_t)> onTestPositive, std::function<void(uint64_t)> onTestNegative)
