...
namespace AdventOfCode
{
	...
	std::multimap<std::string, uint32_t> Directory::FindDirectoriesOfMaxSize(uint32_t maxSize) const
	{
	...
	uint32_t Directory::FindDirectoriesOfMaxSizeInternal(uint32_t maxSize, std::multimap<std::string, uint32_t>& directories) const
	{
