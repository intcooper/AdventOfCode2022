...
namespace AdventOfCode
{
	...
	void Day1::Task2()
	{
		...
		std::partial_sort(elvesCalories.begin(), elvesCalories.begin() + 3, elvesCalories.end(), std::greater<uint32_t>());
		m_result = std::to_string(std::accumulate(elvesCalories.begin(), elvesCalories.begin() + 3, 0));
	}
}